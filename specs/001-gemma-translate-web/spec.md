...
2. **Given** 使用者輸入英文文字（未手動選擇語言），**When** 送出翻譯請求，**Then** 系統應自動偵測為英文並翻譯成中文
3. **Given** 使用者輸入中文文字（未手動選擇語言），**When** 送出翻譯請求，**Then** 系統應自動偵測為中文並翻譯成英文
...
- **FR-002a**: 系統必須提供自動語言偵測功能，當使用者未手動選擇語言時，自動偵測輸入文字的語言（初期僅支援中英文偵測）
- **FR-002b**: 系統必須實作智能語言切換邏輯：偵測到中文時自動設定目標語言為英文，偵測到英文時自動設定目標語言為中文
